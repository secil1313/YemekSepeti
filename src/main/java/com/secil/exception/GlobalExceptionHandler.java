...
//ortama fırlatılan exceptionları yakalar
/**
...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> handlerYemekSepetiException(YemekSepetiException exception){
        System.out.println("YemekSepetiException hatası...: "+ exception.toString());
